...
const Sidebar = ({ toggleSidebar, navOpen }) => {
    ...
    return (
        <Fragment>
            ...
            ></div>
            <div className={`absolute left-0 top-0 z-40 ${navOpen ? 'block w-[230px]' : 'hidden'} md:flex flex-col md:w-[230px] h-screen overflow-y-hidden duration-300 ease-linear bg-primary text-white`}>
                ...
                <div className='w-full py-2.5 px-4 mb-2 bg-primary'>
                    <div className='w-full flex items-center mt-[-30px]'>
                        ...
                        <div className='ml-2 pl-2 grid border-l border-white text-white'>
